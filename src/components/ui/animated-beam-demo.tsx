...
import socialFloLogo from "@/assets/LOGO.png";
...
const Icons = {
  ...
  claude: () => (
    <img src={claudeIcon} alt="Claude" className="w-full h-full object-contain" />
  ),

  wordpress: () => (
    <img src={wordpressIcon} alt="WordPress" className="w-full h-full object-contain" />
  ),
  instagram: () => (
  ...
  socialflo: () => (
    <img src={socialFloLogo} alt="SocialFlo" className="w-full h-full object-contain" />
  ),
  centericon: () => (
    <img src={centerIcon} alt="Center" className="w-full h-full object-contain" />
  ),
  slack: () => (
    <img src={slackIcon} alt="Slack" className="w-full h-full object-contain" />
  ),
  googleDocs: () => (
    <svg
      width="47px"
