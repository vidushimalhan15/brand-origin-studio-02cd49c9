...
.lp { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; color: #1A1A1A; overflow-x: hidden; background: #fff; }
.lp *, .lp *::before, .lp *::after { box-sizing: border-box; margin: 0; padding: 0; }
.lp-heading { font-family: 'DM Serif Display', Georgia, serif; }
...
.lp-banner-btn { background: #FFD02F; color: #1A1A1A; font-size: 11px; font-weight: 600; padding: 4px 11px; border-radius: 5px; text-decoration: none; white-space: nowrap; letter-spacing: .03em; transition: opacity .2s; }
...
.lp-h1 { font-family: 'DM Serif Display', Georgia, serif; font-size: clamp(46px, 6vw, 72px); font-weight: 400; line-height: 1.08; letter-spacing: -.01em; color: #111; margin-bottom: 28px; }
.lp-h1 .lp-yellow { color: #111; position: relative; display: inline-block; }
.lp-h1 .lp-yellow::after { content: ''; position: absolute; left: 0; bottom: -2px; width: 100%; height: 4px; background: #FFD02F; border-radius: 2px; }
...
.lp-btn-yellow { font-size: 15px; font-weight: 500; color: #1A1A1A; background: #FFD02F; border: none; border-radius: 7px; padding: 13px 26px; text-decoration: none; transition: opacity .2s; cursor: pointer; display: inline-flex; align-items: center; gap: 7px; }
...
.lp-section-title { font-family: 'DM Serif Display', Georgia, serif; font-size: clamp(32px, 3.8vw, 48px); font-weight: 400; line-height: 1.12; letter-spacing: -.01em; color: #111; margin-bottom: 18px; }
...
.lp-ps-tab-active { color: #111 !important; border-bottom-color: #FFD02F !important; }
.lp-ps-panel { background: #fff; border: 1px solid #F0F0F0; border-top: none; border-radius: 0 0 14px 14px; padding: 48px 52px; }
.lp-ps-metric { font-family: 'DM Serif Display', Georgia, serif; font-size: clamp(38px, 4vw, 54px); font-weight: 400; color: #111; line-height: 1; letter-spacing: -.01em; margin-bottom: 8px; }
...
.lp-ps-check { width: 16px; height: 16px; background: #FFD02F; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 3px; font-size: 9px; font-weight: 700; }
...
.lp-cta-t { font-family: 'DM Serif Display', Georgia, serif; font-size: clamp(28px, 3vw, 42px); font-weight: 400; color: #fff; line-height: 1.18; letter-spacing: -.01em; margin-bottom: 14px; }
        ...
        <section className="lp-hero">
          <div className="lp-hero-inner">
            ...
            <h1 className="lp-h1">
              ...
              Content that <span className="lp-yellow">gets found.</span>
            </h1>
...
<h2 style={{ fontFamily:"'DM Serif Display',Georgia,serif", fontSize:'clamp(22px,2.8vw,34px)', fontWeight:400, letterSpacing:'-.01em', color:'#fff', marginBottom:8 }}>
                Content built for the age of <span style={{ color:'#FFD02F' }}>AI Search.</span>
              </h2>
            ...
            <div style={{ position:'relative', width:'100%', padding:'8px 0 16px' }}>
              ...
              <svg style={{ position:'absolute', top:0, left:0, width:'100%', height:'100%', overflow:'visible', pointerEvents:'none' }} viewBox="0 0 1000 200" preserveAspectRatio="xMidYMid meet">
                <defs>
                  <linearGradient id="lg-in" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#FFD02F" stopOpacity="0"/>
                    <stop offset="100%" stopColor="#FFD02F" stopOpacity="0.8"/>
                  </linearGradient>
                  <linearGradient id="lg-out" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#FFD02F" stopOpacity="0.8"/>
                ...
                {[
                  { path:"M 100 40 C 260 40, 380 100, 480 100",  color:"#FFD02F", dur:"2.2s", begin:"0s" },
                  { path:"M 100 80 C 260 80, 380 100, 480 100",  color:"#A78BFA", dur:"2.2s", begin:"0.55s" },
                  { path:"M 100 120 C 260 120, 380 100, 480 100", color:"#FFD02F", dur:"2.2s", begin:"1.1s" },
              ...
              <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', position:'relative', zIndex:1, minHeight:160 }}>
                ...
                <div style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:10 }}>
                  ...
                  <span style={{ fontSize:13, fontWeight:700, color:'#FFD02F', letterSpacing:'0.02em' }}>SocialFlow</span>
                </div>
